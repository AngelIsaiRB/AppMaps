...
// obtener informacion des destino  
    final reverseQueryResponse = await traficService.getCoordenadasInfo(destino);
    ...
    mapaBloc.add(OnCrearRutaIniciodestino(coordList, distancia, duration,nombreDestino));
